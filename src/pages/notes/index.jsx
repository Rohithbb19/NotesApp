            ...
            <div className="h-full min-h-[100vh] relative bg-[#272727]">
                ...
                <div className="flex w-full justify-center mt-10">
                    <div className="flex gap-5 w-full max-w-[1500px]">
                        <SideBar current={current} setCurrent={setCurrent} category={category}/>

                        {OpenPopUp && 
                        <PopUp userUID={user?.uid} category={category} setOpenPopUp={setOpenPopUp}></PopUp>
                        }
                        ...
                        >
                            <Add fill="#f2f2f2" className="w-14 h-14 group-hover:scale-110 duration-300"></Add>
                        </div>
                        ...
                        <TaskCard key={index} data={element} deleTask={deleTask} setToggle={setToggle} toggle={toggle}/>
                        ))
