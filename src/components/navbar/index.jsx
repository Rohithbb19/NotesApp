    ...
    return (
        ...
        <div className="flex justify-between items-center p-2 w-full max-w-[1500px] ">
            ...
            <div className=" w-14 h-14 rounded-full bg-black flex justify-center items-center">
                <img className="h-10 " src={logo1}/>
            </div>
            <p className="ml-5">PurpleApe</p>
            </div>

            <div className="flex items-center gap-2">
            <div className=" w-14 h-14 rounded-full flex justify-center items-center border-[3px] border-black">
                {props.pic ?
                <img className="h-10 rounded-full" src={props.pic}/>
            :
            <p className=" text-3xl">{props.name[0].toUpperCase()}</p>    
            }
            </div>
